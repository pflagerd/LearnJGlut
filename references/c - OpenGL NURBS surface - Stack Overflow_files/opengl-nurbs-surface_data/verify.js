    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'0941ea75f8164c98a49b13d1ef3b59a3',
                comparisonItems:[{name : 'cmp', value : 10757048},{name : 'plmt', value : 10867024}]
            }
        };
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_316946831151');
                if (frame) {
...
}, 10);var impId = '0941ea75f8164c98a49b13d1ef3b59a3';var dvObj = $dvbs;var rtnName = dvObj==window.$dv ? 'ImpressionServed' : 'BeforeDecisionRender';dvObj.pubSub.subscribe(rtnName, impId, 'HE_RTN', function () { try {var ifu = '';var alu = 'http://ad.doubleclick.net/ddm/clk/291583327;106680815;k';var lbl='';var d=null,e=dvObj==window.$dv?parent:window,h=0,i=0,k=[],l=[],m=10;

...
public class scene extends glut {
	...
	/*
	 * scene.c This program demonstrates the use of the GL lighting model. Objects
	 * are drawn using a grey material characteristic. A single light source
	...
	public static void main(String[] args) {
		System.exit(new scene().main(args.length, args));
	}
}
